 ...
 */
public class ORCAPreferenceFragment extends PreferenceFragment implements DialogCreatable {
    ...
    public static class SettingsDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            if (savedInstanceState != null) {
                ...
                if (mParentFragment instanceof ORCAPreferenceFragment) {
                    // restore mDialogFragment in mParentFragment
                    ((ORCAPreferenceFragment) mParentFragment).mDialogFragment = this;
                }
            }
        ...
        public void onDetach() {
            ...
            if (mParentFragment instanceof ORCAPreferenceFragment) {
                ...
                if (((ORCAPreferenceFragment) mParentFragment).mDialogFragment == this) {
                    ((ORCAPreferenceFragment) mParentFragment).mDialogFragment = null;
                }
            }
        }
    }
